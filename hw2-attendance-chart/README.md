...
- [ ] Приложение должно представлять из себя таблицу для отметки присутствия студентов на занятии. 
...
- [ ] Написать React-компонент, отображающий таблицу присутствия (можно использовать табличную верску, можно на div-ах). 
Вверху - даты
...
- [ ] (*) По желанию - можно добавть на UI 2 кноки - "добавить студента" и "добавить дату". Использовать prompt для
